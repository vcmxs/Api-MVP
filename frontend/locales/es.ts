...
const es: TranslationKeys = {
  ...
  // ── Programs ──────────────────────────────────────────────────────────────
  programs: {
    title: "Carpetas de Programas",
    subtitle: "Organiza rutinas en carpetas para luego crear planes a partir de ellas",
    newFolder: "Nueva Carpeta",
    noFoldersYet: "Aún no hay carpetas",
    standalonePlans: "Planes Independientes",
    trainingPlansTitle: "Planes de Entrenamiento",
    trainingPlansSubtitle: "Calendarios de varios días que se pueden asignar a cualquier alumno",
    newPlan: "Nuevo Plan",
    noStandalonePlansYet: "Aún no hay planes independientes",
    plansInsideFoldersHint: "Los planes dentro de las carpetas también aparecen en la pestaña Planes de la carpeta",
    createFolderHint: "Crea un plan de entrenamiento de varios días usando rutinas de esta carpeta",
    workoutsTab: "Rutinas",
    plansTab: "Planes",
    addWorkout: "Agregar Rutina",
    ...
    weeks: "semanas",
    workoutCount: "rutina",
    workoutCountPlural: "rutinas",
    planCount: "plan",
    planCountPlural: "planes",
    ...
    type: "Tipo",
    assignToMany: "Asignar a varios",
    singleUse: "Uso único",
    weeklySchedule: "Horario Semanal",
    trainingDaysPerWeek: "días de entrenamiento / semana",
    savePlan: "Guardar Plan",
    assignAndCustomize: "Asignar y Personalizar Plan",
    assignSubtitle: "Personaliza la plantilla para esta asignación específica",
    selectTrainee: "Seleccionar Alumno",
    startDate: "Fecha de Inicio",
    startDateHint: "El plan comienza desde la semana que contiene esta fecha. Las rutinas programadas en días anteriores se omitirán en la primera semana.",
    planDetails: "Detalles del Plan",
    confirmAssignment: "Confirmar Asignación",
    assigning: "Asignando…",
    weeklyTimeline: "Plantilla del Horario Semanal",
    weeklyTimelineHint: "Arrastra rutinas entre los días, o haz clic en una tarjeta para ajustar sus ejercicios específicamente para",
    clickToEdit: "Clic para editar",
    customize: "Personalizar",
    customizeHint: "Los cambios aplican a todas las semanas de esta asignación",
    noExercisesFound: "No se encontraron ejercicios en esta plantilla",
    doneEditing: "Listo",
    edited: "Editado",
    newProgramFolder: "Nueva Carpeta de Programa",
    folderName: "Nombre de la Carpeta",
    color: "Color",
    createFolderBtn: "Crear Carpeta",
    creating: "Creando…",
    placeholderWorkoutName: "ej., Fuerza de Tren Superior",
    placeholderPlanName: "ej., Bloque de Hipertrofia de 4 Semanas",
    placeholderFolderName: "ej., Bloque de Hipertrofia",
    placeholderDescWorkout: "Describe los objetivos de la rutina…",
    placeholderDescPlan: "Objetivos, notas…",
