...
function Login({ onLogin, onToggle }) {
  ...
  const inputStyle = {
    ...
    borderRadius: '10px', color: '#EDF2F7', fontSize: '15px',
  ...
  return (
    <div style={{
      ...
      background: '#07090F', padding: '20px',
      ...
      <div style={{ width: '100%', maxWidth: '400px', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{
          ...
          borderRadius: '20px', padding: '32px', boxShadow: '0 24px 64px rgba(0,0,0,0.5)',
        }}>
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            <div>
              ...
              <input type="email" value={email} onChange={e => setEmail(e.target.value)}
                required placeholder="you@example.com" style={inputStyle} onFocus={onFocus} onBlur={onBlur} />
            </div>
            <div>
            ...
            <button type="submit" disabled={loading} style={{
              ...
              color: '#fff', fontWeight: '700', padding: '13px', borderRadius: '10px',
              border: 'none', fontSize: '15px', cursor: loading ? 'wait' : 'pointer',
              marginTop: '6px', transition: 'opacity 0.2s, transform 0.2s',
              letterSpacing: '0.5px', boxShadow: '0 4px 16px rgba(0,196,255,0.25)',
              opacity: loading ? 0.7 : 1, fontFamily: "'Inter', -apple-system, sans-serif",
            }}
